...
public class EntityUtil implements IEntityUtil {
    ...
    public void moveDragon(Player player, Vector vector, org.bukkit.entity.Entity entity) {
        ...
        ec.move(EnumMoveType.SELF, v1.getX(), v.getY(), v1.getZ()); //had to add an EnumMoveType, this is probably important.
    }
    ...
    public void moveShip(Player player, org.bukkit.entity.Entity entity, Vector vector) {
        ...
        ec.move(EnumMoveType.SELF, 1, 0, 0); //had to add an EnumMoveType, this is probably important.
    }
