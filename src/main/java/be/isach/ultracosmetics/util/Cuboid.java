...
public class Cuboid implements Iterable<Block>, Cloneable,
    ...
    /**
     * Expand the Cuboid in the given direction by the given amount. Negative amounts will shrink the Cuboid in the given direction. Shrinking a cuboid's face past the opposite
     * face is not an error and will return a valid Cuboid.
     *
    ...
    /**
     * Contract the Cuboid in the given direction, returning a new Cuboid which has no exterior empty space. E.g. A direction of Down will push the top face downwards as much as
     * possible.
     *
    ...
    /**
     * Get a block relative to the lower NE point of the Cuboid in the given World. This version of getRelativeBlock() should be used if being called many times, to avoid excessive
     * calls to getWorld().
     *
     * @param w - The world
     * @param x - The X co-ordinate
