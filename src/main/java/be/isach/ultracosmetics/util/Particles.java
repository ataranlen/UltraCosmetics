...
public enum Particles {
    ...
    /**
     * Displays a single particle which requires additional data that flies into a determined direction and is only visible for all players within a certain range in the world of
     *
     * @param center
     *
     * @param data Data of the effect
    ...
    public static final class ParticlePacket {
        ...
        /**
         * Initializes {@link #packetConstructor}, {@link #getHandle}, {@link #playerConnection} and {@link #sendPacket} and sets {@link #initialized} to <code>true</code> if it
         * succeeds
         * <p>
