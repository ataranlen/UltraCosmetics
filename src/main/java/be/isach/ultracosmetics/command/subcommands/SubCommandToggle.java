        ...
        if (type.startsWith("g")) {
            ...
            try {
                ...
                for (int i = 0; i < GadgetType.enabled().size(); i++) {
                    sb.append(GadgetType.enabled().get(i).toString().toLowerCase()).append((i != GadgetType.enabled().size() - 1) ? "§f§l, §c" : "");
                }
            ...
            try {
                ...
                for (int i = 0; i < PetType.enabled().size(); i++) {
                    sb.append(PetType.enabled().get(i).toString().toLowerCase()).append((i != PetType.enabled().size() - 1) ? "§f§l, §c" : "");
                }
            ...
            try {
                ...
                for (int i = 0; i < ParticleEffectType.enabled().size(); i++) {
                    sb.append(ParticleEffectType.enabled().get(i).toString().toLowerCase()).append((i != ParticleEffectType.enabled().size() - 1) ? "§f§l, §c" : "");
                }
            ...
            try {
                ...
                for (int i = 0; i < MountType.enabled().size(); i++) {
                    sb.append(MountType.enabled().get(i).toString().toLowerCase()).append((i != MountType.enabled().size() - 1) ? "§f§l, §c" : "");
                }
            ...
            if (stopNow || emoteType == null) {
                ...
                for (int i = 0; i < EmoteType.enabled().size(); i++) {
                    sb.append(EmoteType.enabled().get(i).toString().toLowerCase()).append((i != EmoteType.enabled().size() - 1) ? "§f§l, §c" : "");
                }
            ...
            try {
                ...
                for (int i = 0; i < MorphType.enabled().size(); i++) {
                    sb.append(MorphType.enabled().get(i).toString().toLowerCase()).append((i != MorphType.enabled().size() - 1) ? "§f§l, §c" : "");
                }
            ...
            try {
                ...
                for (int i = 0; i < Hat.enabled().size(); i++) {
                    sb.append(Hat.enabled().get(i).toString().toLowerCase()).append((i != Hat.enabled().size() - 1) ? "§f§l, §c" : "");
                }
                sender.sendMessage("§c§lMorph Types: §c" + sb.toString());
                return;
            }
            ...
            try {
                ...
                for (int i = 0; i < SuitType.enabled().size(); i++) {
                    sb.append(SuitType.enabled().get(i).toString().toLowerCase()).append((i != SuitType.enabled().size() - 1) ? "§f§l, §c" : "");
                }
