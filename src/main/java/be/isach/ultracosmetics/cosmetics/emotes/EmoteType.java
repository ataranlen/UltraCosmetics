...
/**
 * Project: UltraCosmetics Package: be.isach.ultracosmetics.cosmetics.emotes Created by: Sacha Created on: 17th June, 2016 at 02:45
 */
public final class EmoteType {
 ...
 /* WINK BEGIN */
    ...
    private static final Class<Emote> CLASS = Emote.class;
