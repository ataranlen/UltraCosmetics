...
public abstract class CosmeticType<T> {
    ...
    public final void setDescriptionAsString(String descriptionAsString) {
        this.descriptionAsString = descriptionAsString;
    }

    /**
     * Transforms the description from a String to a list. Without colors.
     *
    ...
    /**
     * Transforms the description from a String to a list. With colors.
     *
     * @return The description as a list.
     */
    public final List<String> getDescriptionColored() {
