...
/**
 * Project: UltraCosmetics Package: be.isach.ultracosmetics.cosmetics Created by: Sacha Created on: 20th June, 2016 at 22:35
 */
public enum Category {
    ...
    /**
     * Creates Material data from a text. {id}:{data}
     *
