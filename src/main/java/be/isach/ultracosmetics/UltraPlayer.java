 ...
 */
public final class UltraPlayer {
        ...
        try {
            ...
            if (UltraCosmetics.getInstance().isAmmoEnabled()) {
                if (!UltraCosmetics.getInstance().usingFileStorage()) {
                    ...
                    GadgetType.values().stream().filter((type) -> (type.isEnabled())).forEach((type) -> {
    ...
    public void removePet() {
        if (currentPet != null) {
            ...
            currentPet.items.stream().forEach((item) -> {
                item.remove();
            });
            currentPet.clear();
            currentPet = null;
    ...
    public void openKeyPurchaseMenu() {
        ...
        try {
            ...
            Bukkit.getScheduler().runTaskLater(UltraCosmetics.getInstance(), () -> {
    ...
    public void setPetName(String petName, String name) {
        if (UltraCosmetics.getInstance().usingFileStorage()) {
            ...
            UltraCosmetics.sqlUtils.setName(getMySqlIndex(), petName, name);
        }
    }
    ...
    public boolean hasGadgetsEnabled() {
        ...
        try {
            ...
            } else if (UltraCosmetics.sqlUtils.hasGadgetsEnabled(getMySqlIndex())) {
    ...
    public boolean canSeeSelfMorph() {
        ...
        try {
            ...
            } else if (UltraCosmetics.sqlUtils.canSeeSelfMorph(getMySqlIndex())) {
